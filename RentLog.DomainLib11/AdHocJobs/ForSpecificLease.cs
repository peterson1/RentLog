...
{
    public static class ForSpecificLease
    {
        ...
        public static Action<LeaseDTO, ITenantDBsDir> FindMemosFrom(DateTime startDate, out string taskDescription)
        {
            ...
            return (lse, dir) =>
            {
                lse.ReprocessBalancedDay(startDate, dir);
            };
        }


        public static void ReprocessBalancedDay(this LeaseDTO lse, DateTime startDate, ITenantDBsDir dir)
        {
